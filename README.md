...
- **Kubernetes** – orchestration of containerized execution environments (under evaluation)
...
- **Kubernetes (planned)** adds the ability to scale and orchestrate these containers efficiently in production.
